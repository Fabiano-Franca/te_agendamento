...
<table class="table table-striped">
	...
	@endif
    @if(isset($lista))
        @for($dia = 1, $itemAnterior = null, $diaFeriado = array(20), $finalSemana = array(1, 2, 8, 9, 15, 16, 22, 23, 29, 30); $dia <= 30; $dia++)
        @if(in_array($dia, $diaFeriado, true)) <!-- Inicio IF $diaFeriado-->
                @if($dia < 10)
                    <thead>
                        <th class='diaFeriado' colspan='9'> FERIADO - 0{{$dia}}/06/2019</th>
                    </thead>
                @else
                    <thead>
                        <th class='diaFeriado' colspan='9'> FERIADO - {{$dia}}/06/2019</th>
                    </thead>
                @endif
                ...
                @elseif(in_array($dia, $finalSemana, true))
                    @if($dia < 10)
                        <thead>
                            <th class='finalDeSemana' colspan='9'>Final de Semana (Sab/Dom) - 0{{$dia}}/06/2019</th>
                        </thead>
                    @else
                        <thead>
                            <th class='finalDeSemana' colspan='9'>Final de Semana (Sab/Dom) - {{$dia}}/06/2019</th>
                        </thead>
                    @endif
                @else
                    @if($dia < 10)
                        <thead>
                            <th class='dia_agendamento' colspan='9'>0{{$dia}}/06/2019</th>
                        </thead>
                    @else
                        <thead>
                            <th class='dia_agendamento' colspan='9'>{{$dia}}/06/2019</th>
                        </thead>
                    @endif
