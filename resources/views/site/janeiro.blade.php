...
<table class="table table-striped">
	...
	<h1>JANEIRO</h1>
    @if(isset($lista))
        @for($dia = 1, $itemAnterior = null, $diaFeriado = array(1), $finalSemana = array(4, 5, 11, 12, 19, 20, 25, 26); $dia <= 31; $dia++)
        @if(in_array($dia, $diaFeriado, true)) <!-- Inicio IF $diaFeriado-->
                @if($dia < 10)
                    <thead>
                        <th class='diaFeriado' colspan='9'> FERIADO - 0{{$dia}}/05/2019</th>
                    </thead>
                @else
                    <thead>
                        <th class='diaFeriado' colspan='9'> FERIADO - {{$dia}}/05/2019</th>
                    </thead>
                @endif
                ...
                @elseif(in_array($dia, $finalSemana, true))
                    @if($dia < 10)
                        <thead>
                            <th class='finalDeSemana' colspan='9'>Final de Semana (Sab/Dom) - 0{{$dia}}/05/2019</th>
                        </thead>
                    @else
                        <thead>
                            <th class='finalDeSemana' colspan='9'>Final de Semana (Sab/Dom) - {{$dia}}/05/2019</th>
                        </thead>
                    @endif
                @else
                    @if($dia < 10)
                            ...
                            @else
                                ...
                                {!! csrf_field() !!}
                                    <tr id='2019-05-{{$dia}} {{$horario}}:00'>
                                        ...
                                        <td class='id_td'>
                                            <input type='text' id='id_monitorado' name='id_monitorado' class='id_mon form-control'>
                                        </td>
                                        <td class='nome_td'>
                                            <input class='nome_input form-control' id="nome_monitorado" name='nome_monitorado' type="text">
                                        </td>
                                        <td class='motivo_td'>
