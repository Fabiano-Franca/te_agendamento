...
<table class="table table-striped">
	...
	@endif
    @if(isset($lista))
        @for($dia = 1, $itemAnterior = null, $diaFeriado = array(), $finalSemana = array(5, 6, 12, 13, 19, 20, 26, 27); $dia <= 31; $dia++)
        @if(in_array($dia, $diaFeriado, true)) <!-- Inicio IF $diaFeriado-->
                @if($dia < 10)
                    <thead>
                        <th class='diaFeriado' colspan='9'> FERIADO - 0{{$dia}}/10/2019</th>
                    </thead>
                @else
                    <thead>
                        <th class='diaFeriado' colspan='9'> FERIADO - {{$dia}}/10/2019</th>
                    </thead>
                @endif
                ...
                @elseif(in_array($dia, $finalSemana, true))
                    @if($dia < 10)
                        <thead>
                            <th class='finalDeSemana' colspan='9'>Final de Semana (Sab/Dom) - 0{{$dia}}/10/2019</th>
                        </thead>
                    @else
                        <thead>
                            <th class='finalDeSemana' colspan='9'>Final de Semana (Sab/Dom) - {{$dia}}/10/2019</th>
                        </thead>
                    @endif
                @else
                    @if($dia < 10)
                        <thead>
                            <th class='dia_agendamento' colspan='9'>0{{$dia}}/10/2019</th>
                        </thead>
                    @else
                        <thead>
                            <th class='dia_agendamento' colspan='9'>{{$dia}}/10/2019</th>
                        </thead>
                    @endif
